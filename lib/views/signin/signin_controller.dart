...
class SignInController extends GetxController {
  ...
  Future<void> userSignIn(BuildContext context) async {
    ...
    try {
      ...
      final response = await _signInRequest(emailOrUsername, password);
  ...
  Future<http.Response> _signInRequest(
    ...
    return await http.post(url, headers: header, body: json.encode(body));
  }
